...
public abstract class StatementTest {
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorExamplefile10() {
        /*
         * Setup
         */
        Statement sTest = this.constructorTest();
     ...
     */
    @Test
    public final void testParseValidExamplefile6() {
        /*
         * Setup
         */
        Statement sRef = this.constructorRef();
     ...
     */
    @Test
    public final void testParseValidExamplefile7() {
        /*
         * Setup
         */
        Statement sRef = this.constructorRef();
     ...
     */
    @Test
    public final void testParseValidExamplefile8() {
        /*
         * Setup
         */
        Statement sRef = this.constructorRef();
