...
public final class Program1Parse1 extends Program1 {
    ...
    private static String parseInstruction(Queue<String> tokens,
        ...
        Reporter.assertElseFatalError(tokens.dequeue().equals(name),
                "Error: Instruction name is not matched");
    ...
    public void parse(Queue<String> tokens) {
        ...
        while (tokens.front().equals("INSTRUCTION")) {
            ...
            Reporter.assertElseFatalError(context.hasKey(instructionName),
                    "Error: duplicate instruction names");
        ...
        Reporter.assertElseFatalError(tokens.dequeue().equals("END"),
                "Error: Expect <\"END\">");
        Reporter.assertElseFatalError(tokens.dequeue().equals(name),
                "Error: program name is not matched");
