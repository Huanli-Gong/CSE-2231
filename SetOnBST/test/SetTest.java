...
public abstract class SetTest {
    ...
    @Test
    public final void testAddNonEmptyTwo() {
        /*
         * Set up variables
         */
    ...
    @Test
    public final void testContainsNonEmptyTwoTrue() {
        /*
         * Set up variables
         */
        Set<String> s = this.createFromArgsTest("red", "green");
    ...
    @Test
    public final void testContainsNonEmptyTwoTrue2() {
        /*
         * Set up variables
         */
        Set<String> s = this.createFromArgsTest("red", "green");
    ...
    @Test
    public final void testContainsNonEmptyTwoFalse() {
        /*
         * Set up variables
         */
        Set<String> s = this.createFromArgsTest("red", "green");
    ...
    @Test
    public final void testContainsNonEmptyMoreThanOneTrue2() {
        /*
         * Set up variables
         */
        Set<String> s = this.createFromArgsTest("red", "green", "blue");
    ...
    @Test
    public final void testContainsNonEmptyMoreThanOneTrue3() {
        /*
         * Set up variables
         */
        Set<String> s = this.createFromArgsTest("red", "green", "blue");
         ...
         * Call method under test
         */
        boolean contains = s.contains("blue");
        /*
         * Assert that values of variables match expectations
         */
        assertEquals(sExpected, s);
    ...
    @Test
    public final void testContainsNonEmptyMoreThanOneFalse2() {
        /*
         * Set up variables
         */
        Set<String> s = this.createFromArgsTest("red", "green", "blue");
