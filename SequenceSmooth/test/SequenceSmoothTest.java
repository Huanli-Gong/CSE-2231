...
public final class SequenceSmoothTest {
    ...
    /**
     * Test smooth with s1 = <1,2,3,2,1> and s2 = <1,2,2,1>.
     */
    @Test
    public void test3() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(1, 2, 3, 2, 1);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(1, 2, 3, 2, 1);
        Sequence<Integer> seq2 = this.createFromArgs(1, 2, 2, 1);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(1, 2, 2, 1);
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
         */
    ...
    /**
     * Test smooth with s1 = <0,1,0,1,0,1> and s2 = <>.
     */
    @Test
    public void test5() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(0, 1, 0, 1, 0, 1);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(0, 1, 0, 1, 0, 1);
        Sequence<Integer> seq2 = this.createFromArgs(0);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(0, 0, 0, 0, 0);
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
         */
    ...
    /**
     * Test smooth with s1 = <7, -7> and s2 = <-7>.
     */
    @Test
    public void test6() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(7, -7);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(7, -7);
        Sequence<Integer> seq2 = this.createFromArgs(-7);
    ...
    /**
     * Test smooth with s1 = < 1073741825, 1073741825 >, s2 = < >.
     */
    @Test
    public void test7() {
        /*
        ...
        seq2 = SequenceSmooth.smooth(seq1);
        /*
         * Assert that values of variables match expectations
         */
        assertEquals(expectedSeq1, seq1);
