...
public final class CountPrimitiveCallsTest {
    ...
    public void test3true() {
        Statement s1 = this.createFromArgs("data/test1.bl", true);
        Statement s2 = this.createFromArgs("data/test1.bl", true);
        int count = CountPrimitiveCalls.countOfInstructionCalls(s1, "turnback");
    ...
    public void test4true() {
        ...
        CountPrimitiveCalls.renameInstruction(s1, "turnback", "move");
        assertEquals(s2, s1);
    }
    ...
    public void test5true() {
        Statement s1 = this.createFromArgs("data/test1.bl", true);
        Statement s2 = this.createFromArgs("data/test4.bl", true);
