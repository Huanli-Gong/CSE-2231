...
public abstract class StatementTest {
    ...
    private static final String FILE_NAME_1 = "data/statement-sample.bl",
            FILE_NAME_2 = "data/statement-sample2.bl",
            FILE_NAME_3 = "data/statement-sample3.bl",
            FILE_NAME_4 = "data/statement-sample4.bl",
            FILE_NAME_5 = "data/statement-sample5.bl",
            FILE_NAME_6 = "data/statement-sample6.bl",
            FILE_NAME_7 = "data/statement-sample7.bl",
            FILE_NAME_8 = "data/statement-sample8.bl",
            FILE_NAME_9 = "data/statement-sample9.bl",
            FILE_NAME_10 = "data/statement-sample10.bl";
     ...
     */
    @Test
    public final void testAddToBlockInteriorone() {
        /*
         * Setup
         */
     ...
     */
    @Test
    public final void testAddToBlockInterior4() {
        /*
         * Setup
         */
     ...
     */
    @Test
    public final void testAddToBlockInterior5() {
        /*
         * Setup
         */
        Statement sTest = this.createFromFileTest(FILE_NAME_3);
     ...
     */
    @Test
    public final void testRemoveFromBlockFrontLeavingNonEmptyfile8() {
        /*
         * Setup
         */
        Statement sTest = this.createFromFileTest(FILE_NAME_8);
        Statement sRef = this.createFromFileRef(FILE_NAME_8);
        Statement nestedRef = sRef.removeFromBlock(0);
     ...
     */
    @Test
    public final void testRemoveFromBlockFrontLeavingNonEmptyfile3() {
        /*
         * Setup
         */
        Statement sTest = this.createFromFileTest(FILE_NAME_3);
     ...
     */
    @Test
    public final void testRemoveFromBlockFrontLeavingNonEmptyfile4() {
        /*
         * Setup
         */
        Statement sTest = this.createFromFileTest(FILE_NAME_4);
        Statement sRef = this.createFromFileRef(FILE_NAME_4);
        Statement nestedRef = sRef.removeFromBlock(4);

        /*
         * The call
         */
        Statement nestedTest = sTest.removeFromBlock(4);
     ...
     */
    @Test
    public final void testLengthOfBlockNonEmptyfile10() {
        /*
         * Setup
         */
        Statement sTest = this.createFromFileTest(FILE_NAME_10);
        Statement sRef = this.createFromFileRef(FILE_NAME_10);
        int lengthRef = sRef.lengthOfBlock();
     ...
     */
    @Test
    public final void testAssembleIffile4() {
        /*
         * Setup
         */
     ...
     */
    @Test
    public final void testAssembleIffile6() {
        /*
         * Setup
         */
     ...
     */
    @Test
    public final void testAssembleIffile8() {
        /*
         * Setup
         */
     ...
     */
    @Test
    public final void testDisassembleIffile3() {
        /*
         * Setup
         */
     ...
     */
    @Test
    public final void testDisassembleIfElse9() {
        /*
         * Setup
         */
        final int ifElsePos = 2;
        Statement blockTest = this.createFromFileTest(FILE_NAME_9);
        Statement blockRef = this.createFromFileRef(FILE_NAME_9);
        Statement sTest = blockTest.removeFromBlock(ifElsePos);
        Statement sRef = blockRef.removeFromBlock(ifElsePos);
        Statement thenBlockTest = sTest.newInstance();
        Statement elseBlockTest = sTest.newInstance();
     ...
     */
    @Test
    public final void testAssembleWhile5() {
        /*
         * Setup
         */
        Statement blockTest = this.createFromFileTest(FILE_NAME_8);
     ...
     */
    @Test
    public final void testDisassembleWhile8() {
        /*
         * Setup
         */
        final int whilePos = 3;
     ...
     */
    @Test
    public final void testDisassembleCall9() {
        /*
         * Setup
         */
        Statement blockTest = this.createFromFileTest(FILE_NAME_9);
